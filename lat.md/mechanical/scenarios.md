...
진입점: `[[Mechanical/MXSimulator/main.py#ModalDialog]]` (라인 568). 콜백: `show_modal_dialog`.
...
진입점: `[[Mechanical/MXSimulator/main.py#ScenarioDialog]]` (라인 694). 콜백: `show_scenario_dialog`. 헤드리스 실행 진입점은 `[[Mechanical/MXSimulator/run_cap_vibration.py]]`.
